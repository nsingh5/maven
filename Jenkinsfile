                    ...
                    withSonarQubeEnv {
                        ...
                        try {
                            if (isUnix()) {
                                ...
                                bat(/"${mvnHome}\bin\mvn"  sonar:sonar  -Dsonar.projectKey=DGFChatbot  -Dsonar.host.url=http:\\localhost:9007 -Dsonar.login=de474f2213a860ac5287ce7f98e472c108adc637 -Dmaven.test.failure.ignore=true/)
                            }
